...
- Steve in marketing wants an attractive site that works well with a modern browser on **any screen size** — responsive design is required from the first page onward.
